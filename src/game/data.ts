...
export const BUILDINGS: Building[] = [
  { id: 'paw', name: 'Zampetta', emoji: '🐾', description: 'Una zampetta instancabile.', baseCost: 15, cps: 0.1 },
  { id: 'sitter', name: 'Dog sitter', emoji: '🧑‍🦱', description: 'Coccole professionali.', baseCost: 100, cps: 1 },
  { id: 'walker', name: 'Dog walker', emoji: '🦮', description: 'Passeggiate senza fine.', baseCost: 1_100, cps: 8 },
  { id: 'park', name: 'Parco cani', emoji: '🌳', description: 'Il paradiso delle code.', baseCost: 12_000, cps: 47 },
  { id: 'groomer', name: 'Toelettatore', emoji: '🫧', description: 'Puliti, soffici, felici.', baseCost: 130_000, cps: 260 },
  { id: 'shop', name: 'Pet shop', emoji: '🦴', description: 'Snack e giochi in quantità.', baseCost: 1_400_000, cps: 1_400 },
  { id: 'school', name: 'Scuola cinofila', emoji: '🎓', description: 'Laureati in coccolologia.', baseCost: 20_000_000, cps: 7_800 },
  { id: 'shelter', name: 'Rifugio felice', emoji: '🏡', description: 'Una casa per ogni cagnetto.', baseCost: 330_000_000, cps: 44_000 },
]
